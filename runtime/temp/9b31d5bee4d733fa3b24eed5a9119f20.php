<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/entry/index.html";i:1493302258;s:77:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/base.html";i:1497239943;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="navbar-header">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="http://www.cnys.com/" target="_blank"><i class="fa fa-w fa-file-code-o"></i>
                                中华养生网</a>
                        </li>
                        <li>
                            <a href="http://www.zhzyw.org/" target="_blank"><i class="fa fa-w fa-file-code-o"></i>
                                中华中医网</a>
                        </li>
                        <li>
                            <a href="http://guahao.zjol.com.cn/" target="_blank"><i class="fa fa-w fa-file-code-o"></i>
                                浙江在线预约诊疗服务平台 </a>
                        </li>
                        <li>
                            <a href="http://doclu.cn/" target="_blank"><i class="fa fa-w fa-file-code-o"></i>
                                前台首页 </a>
                        </li>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <div class="panel-heading" role="button" data-toggle="collapse" href="#collapseExample6"
                     aria-expanded="false" aria-controls="collapseExample">
                    <h4 class="panel-title">百度推广</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="#collapseExample5" aria-expanded="true">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus collapse in" id="collapseExample6">
                    <a href="<?php echo url('admin/webset/handle'); ?>" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        百度站点提交
                    </a>
                ...
                <div class="panel-heading" role="button" data-toggle="collapse" href="#collapseExample7"
                     aria-expanded="false" aria-controls="collapseExample">
                    <h4 class="panel-title">微信开发</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="#collapseExample5" aria-expanded="true">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus collapse in" id="collapseExample7">
                    <a href="<?php echo url('admin/webset/wx'); ?>" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        接口配置
                    </a>
