<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/Applications/MAMP/htdocs/blog/public/../application/index/view/index/index.html";i:1493294143;s:73:"/Applications/MAMP/htdocs/blog/public/../application/index/view/base.html";i:1493289685;}*/ ?>
...
<article class="_carousel">
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                <img src="__STATIC__/index/images/22.jpg">
            </div>
            <div class="item">
                <img src="__STATIC__/index/images/33.jpg">
            </div>
        </div>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <aside class="col-md-4 hidden-sm hidden-xs">
                <div class="_widget">
                    <h4>关于柏林中西医</h4>
                    <div class="_info">
                        <p>以中西医结合对以下疾病的调控有其独特见解：</p>

                           <p> 1.妇科病：如月经病、带下病、乳腺疾病及症瘕积聚等；</p>

                           <p> 2.内科病: 如慢性胃炎、咳嗽、哮喘、过敏性鼻炎等；</p>

                            <p>3.皮肤病：如湿疹、荨麻疹、痤疮等；</p>

                        <p>4.慢性病:如肿瘤、糖尿病、高血压等；</p>

                        <p>5.风湿免疫病：如系统性红斑狼疮等；</p>

                        <p>6.膏方如：老慢支、慢性鼻炎、体质虚易感冒等尤为适宜；</p>

                        <p>7.其他身体常见病、多发病等。</p>
                        <p>
                            <i class="glyphicon glyphicon-volume-down"></i>
                            <a href="http://www.houdunwang.com" target="_blank">卢柏林</a>
                        </p>
                    </div>
                </div>
                <div class="_widget">
