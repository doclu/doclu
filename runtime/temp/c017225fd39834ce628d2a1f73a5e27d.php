<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/product/edit.html";i:1536115857;s:77:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/base.html";i:1536111852;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    <li><a href="<?php echo url('index'); ?>">宝贝管理</a></li>
    <li class="active"><a href="">宝贝编辑</a></li>
</ul>
<form class="form-horizontal" id="form"  action="" method="post">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">宝贝管理</h3>
        </div>
        <div class="panel-body">
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">宝贝排序</label>
                <div class="col-sm-9">
                    <input type="number" name="pro_sort"  class="form-control" placeholder="" value="<?php echo $oldData['pro_sort']; ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">宝贝摘要</label>
                <div class="col-sm-9">
                    <textarea type="text" name="pro_digest"  class="form-control" placeholder="宝贝摘要"><?php echo $oldData['pro_digest']; ?></textarea>
                </div>
            </div>
            
        </div>
    </div>
    <input type="hidden" name="pro_id" value="<?php echo input('param.pro_id'); ?>">
