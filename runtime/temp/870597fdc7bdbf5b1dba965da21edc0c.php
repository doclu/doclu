<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/product/index.html";i:1536112402;s:77:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/base.html";i:1536111852;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    <li class="active"><a href="#tab1">宝贝管理</a></li>
    <li><a href="<?php echo url('store'); ?>">宝贝添加</a></li>
</ul>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo url('edit',['pro_id'=>$vo['pro_id']]); ?>">编辑</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo url('delToRecycle',['pro_id'=>$vo['pro_id']]); ?>">删除到回收站</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
