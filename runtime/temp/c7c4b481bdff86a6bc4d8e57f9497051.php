<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Applications/MAMP/htdocs/mesunglo/public/../application/index/view/lists/index.html";i:1536117294;s:77:"/Applications/MAMP/htdocs/mesunglo/public/../application/index/view/base.html";i:1536121254;}*/ ?>
...
<article>
    <div class="_head">
        <h1><?php echo $vo['pro_title']; ?></h1>
        <span>
								供货地址：
								<?php echo $vo['pro_place']; ?>
								</span>
        •
        <!--pubdate表⽰示发布⽇日期-->
    ...
    <div class="_digest">
        <img src="<?php echo $vo['pro_thumb']; ?>"  class="img-responsive"/>
        <p>
            <?php echo $vo['pro_digest']; ?>
        </p>
    </div>
    <div class="_more">
        <a href="<?php echo $vo['pro_url']; ?>" class="btn btn-default">查看原链接</a>
    </div>
    <div class="_footer">
