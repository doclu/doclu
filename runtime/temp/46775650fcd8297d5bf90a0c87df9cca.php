<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Applications/MAMP/htdocs/blog/public/../application/admin/view/article/edit.html";i:1492429930;s:73:"/Applications/MAMP/htdocs/blog/public/../application/admin/view/base.html";i:1493286595;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    <title>柏林中西医案例管理系统</title>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">柏林病例管理系统</a>
                </h4>
                <div class="navbar-header">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="" target="_blank"><i class="fa fa-w fa-file-code-o"></i>
                                医疗在线</a>
                        </li>
                        <li>
                            <a href="" target="_blank"><i
                                    class="fa fa-w fa-hand-o-right"></i> 病例库</a>
                        </li>
                        <li>
                            <a href="http://www.doclu.cn/public" target="_blank"><i class="fa fa-w fa-forumbee"></i> 访问网站</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="arc_title"  class="form-control" placeholder="" value="<?php echo $oldData['arc_title']; ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">文章作者</label>
                <div class="col-sm-9">
                    <input type="text" name="arc_author"  class="form-control" placeholder="" value="<?php echo $oldData['arc_author']; ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <label class="checkbox-inline">
                        <input <?php if(in_array($vo['tag_id'],$tag_ids)): ?>checked<?php endif; ?> type="checkbox" name="tag[]" value="<?php echo $vo['tag_id']; ?>"> <?php echo $vo['tag_name']; ?>
                    </label>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
