<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/product/store.html";i:1536108052;s:77:"/Applications/MAMP/htdocs/mesunglo/public/../application/admin/view/base.html";i:1536111852;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="">宝贝添加</a></li>
</ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">宝贝链接</label>
                <div class="col-sm-9">
                    <input type="text" name="pro_url"  class="form-control" placeholder="http://">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">宝贝排序</label>
                <div class="col-sm-9">
                    <input type="number" name="pro_sort"  class="form-control" placeholder="" value="100">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" name="pro_digest"  class="form-control" placeholder="宝贝摘要"></textarea>
                </div>
            </div>
